/**
 * U10男子ビーチフラッグス: 印刷スタートリストの HEAT/レーンに合わせる
 *
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/patch-kanagawa28-u10-men-beach-flags-startlist.ts --dry-run
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/patch-kanagawa28-u10-men-beach-flags-startlist.ts --execute
 */
...
const EVENT_ID = "cmnumdk340008l104yg3ok6gf";
...
async function main() {
  ...
  console.log("\n[execute] U10男子ビーチフラッグス HEAT 割当を更新しました");
}
