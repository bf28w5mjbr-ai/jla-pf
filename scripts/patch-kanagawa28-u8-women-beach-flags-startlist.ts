/**
 * U8女子ビーチフラッグス: 印刷スタートリストの HEAT/レーンに合わせる
 *
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/patch-kanagawa28-u8-women-beach-flags-startlist.ts --dry-run
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/patch-kanagawa28-u8-women-beach-flags-startlist.ts --execute
 */
...
const EVENT_ID = "cmnumsnqi000fkv04484bigba";
...
async function main() {
  ...
  console.log("\n[execute] U8女子ビーチフラッグス HEAT 割当を更新しました");
}
