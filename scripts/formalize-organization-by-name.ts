 ...
 *
 * Usage:
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/formalize-organization-by-name.ts
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/formalize-organization-by-name.ts -- "団体名の一部"
 */
