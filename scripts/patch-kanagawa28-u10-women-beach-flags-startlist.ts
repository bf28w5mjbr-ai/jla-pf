/**
 * U10女子ビーチフラッグス: 印刷スタートリストの HEAT/レーンに合わせる
 *
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/patch-kanagawa28-u10-women-beach-flags-startlist.ts --dry-run
 *   pnpm exec tsx --tsconfig tsconfig.json --env-file=.env scripts/patch-kanagawa28-u10-women-beach-flags-startlist.ts --execute
 */
...
const EVENT_ID = "cmnumdk340009l104wnsuhnuv";
...
async function main() {
  ...
  console.log("\n[execute] U10女子ビーチフラッグス HEAT 割当を更新しました");
}
